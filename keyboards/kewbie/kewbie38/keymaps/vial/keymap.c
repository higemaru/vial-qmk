...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [0] = LAYOUT(
            ...
            CTL_T(KC_TAB), LALT_T(KC_TAB), LGUI_T(KC_ESC), LT(1,KC_SPC), LT(2,KC_SPC), KC_ENT, KC_BSPC, SFT_T(KC_ESC)
        ),
        ...
        [2] = LAYOUT(
            ...
            KC_TRNS, KC_TRNS, KC_TRNS, MO(3),  KC_TRNS, KC_TRNS, KC_TRNS, SFT_T(KC_ESC)
        ),
