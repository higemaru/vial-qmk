...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [0] = LAYOUT(
            ...
            KC_LSFT, CTL_T(KC_TAB), LALT_T(KC_TAB), LGUI_T(KC_ESC), LT(1,KC_SPC), LT(2,KC_SPC), KC_ENT,  KC_BSPC,SFT_T(KC_ESC), KC_SLSH
        ),

        [1] = LAYOUT(
            KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC,   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TRNS,
            KC_TRNS, KC_1,    KC_2,  KC_3,    KC_4,   KC_5,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_TRNS,
            KC_TRNS, KC_TRNS, KC_EQL, KC_PLUS, KC_MINS, KC_GRV,          KC_QUOT, KC_DQUO,  KC_LBRC, KC_RBRC, KC_SLSH, KC_TRNS,
            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  MO(3), KC_TRNS, KC_TRNS, KC_TRNS, KC_PIPE
        ),
        ...
        [2] = LAYOUT(
            ...
            KC_TRNS, KC_TRNS, KC_EQL, KC_PLUS,   KC_UNDS, KC_TILD,  KC_QUOT, KC_DQUO, KC_LCBR, KC_RCBR,  KC_BSLS, KC_TRNS,
            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(3),  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PIPE
        ),
