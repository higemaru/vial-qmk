...
//            CTL_T(KC_TAB), LALT_T(KC_TAB), LGUI_T(KC_ESC), LT(1,KC_SPC), LT(2,KC_SPC), KC_ENT, KC_TAB, SFT_T(KC_ESC)
            LALT_T(KC_ESC), CTL_T(KC_TAB), LGUI_T(KC_TAB), LT(1,KC_SPC), LT(2,KC_SPC), KC_ENT, CTL_T(KC_TAB), SFT_T(KC_ESC)
        ),
        ...
        [1] = LAYOUT(
            ...
            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  MO(3), KC_BSPC, KC_TRNS, KC_PIPE
        ),
        ...
        [2] = LAYOUT(
            ...
            KC_TRNS, KC_TRNS, KC_TRNS, MO(3),  KC_TRNS, KC_BSPC, KC_TRNS, KC_BSLS
        ),
